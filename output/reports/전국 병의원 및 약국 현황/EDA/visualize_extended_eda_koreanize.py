"""
강남구 피부과 확장 EDA - 시각화 스크립트 (koreanize 적용)
작성일: 2026-01-31
스타일: 기본 matplotlib/seaborn + koreanize
"""
...
print("[OK] 한글 폰트 설정 완료 (Malgun Gothic)")

print("="*80)
print("강남구 피부과 확장 EDA - 시각화 (koreanize)")
print("="*80)
